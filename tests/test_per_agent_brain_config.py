...
class TestInterfacePerAgentDefaults(unittest.TestCase):
    ...
    def test_experiment_ui_defaults_and_agent_count(self):
        ...
        try:
            ...
            self.assertEqual(app.local_timeout_var.get(), 480.0)
            ...
            self.assertEqual(app.startup_llm_sanity_timeout_var.get(), 360.0)
            ...
            self.assertEqual(app.warmup_timeout_var.get(), 240.0)
            self.assertEqual(app.startup_llm_sanity_completion_tokens_var.get(), 8192)
            self.assertEqual(app.planner_completion_tokens_var.get(), 8192)
        finally:
            app.stop_experiment()
            app.root.destroy()
