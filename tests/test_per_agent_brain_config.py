...
class TestInterfacePerAgentDefaults(unittest.TestCase):
    ...
    def test_experiment_ui_defaults_and_agent_count(self):
        ...
        try:
            ...
            self.assertEqual(app.local_timeout_var.get(), 900.0)
            ...
            self.assertEqual(app.startup_llm_sanity_timeout_var.get(), 900.0)
            ...
            self.assertEqual(app.warmup_timeout_var.get(), 600.0)
            self.assertEqual(app.startup_llm_sanity_completion_tokens_var.get(), 24576)
            self.assertEqual(app.planner_completion_tokens_var.get(), 24576)
        finally:
            app.stop_experiment()
            app.root.destroy()
